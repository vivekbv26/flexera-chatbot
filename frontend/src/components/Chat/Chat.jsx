...
const Message = styled.div`
  ...
  background-color: ${props => (props.type === 'user-message' ? themeColor.userMainColor : themeColor.botMainColor)};
    ...
    <ChatContainer>
      ...
      <ChatBox>
        ...
        {messages.map((msg, index) => (
          ...
          <div className={`message-wrapper ${msg.type == "bot-message"?"left-display":"right-display"}`} >
